...
class _CustomCalendarDatePickerState extends State<CustomCalendarDatePicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final double scaledMaxDayPickerHeight = textScaleFactor > 1.3 ? _maxDayPickerHeight + ((_maxDayPickerRowCount + 1) * ((textScaleFactor - 1) * 8)) : _maxDayPickerHeight;
    return SizedBox(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: MediaQuery.withClampedTextScaling(
        maxScaleFactor: isLandscapeOrientation ? _kDayPickerGridLandscapeMaxScaleFactor : _kDayPickerGridPortraitMaxScaleFactor,
...
class _DayPickerGridDelegate extends SliverGridDelegate {
  ...
  SliverGridLayout getLayout(SliverConstraints constraints) {
    ...
    final double scaledRowHeight = textScaleFactor > 1.3 ? ((textScaleFactor - 1) * 30) + _dayPickerRowHeight : _dayPickerRowHeight;
